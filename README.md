...
| JIRA MCP server | review-jira, secfix, worklog, technotes, code-review | Ticket fetching, worklog submission, comments |
...
### Start a new feature
1. `/review-jira XNA-XXXXX` — analyse the ticket and get an implementation plan
2. Implement the approved plan
3. `/ship pr` — commit, push, and create a PR
4. `/worklog 4h` — log your time
